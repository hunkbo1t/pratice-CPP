...
int main(){
   ...
   int m,n,p,q,t1,t2,s,d,element; int i,j;
   t1=t2=0; m=n=3;
   cout<<"Considering 3x3 matrix.\n";
   cout<<"Enter the first matrix("<<m<<"*"<<n<<"):";		//Get 1st matrix
   for(i=1;i<=m;i++){
      for(j=1;j<=n;j++){
	 cin>>element;
	 if(element!=0){
   ...
   sparse1[0][2]=n;
   sparse1[0][3]=t1;
   cout<<"Enter the second matrix("<<m<<"*"<<n<<"):";		//Get 2nd matrix
   for(i=1;i<=m;i++){
      for(j=1;j<=n;j++){
	 cin>>element;
	 if(element!=0){
